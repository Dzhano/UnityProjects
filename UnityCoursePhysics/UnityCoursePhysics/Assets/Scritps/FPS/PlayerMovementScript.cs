...
public class PlayerMovementScript : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        attachedRigidbody.AddRelativeForce(Input.GetAxis("Horizontal") * speedKoef, 0f, Input.GetAxis("Vertical") * speedKoef, ForceMode.VelocityChange);
